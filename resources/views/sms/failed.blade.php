    ...
    <div class="col-lg-10">
        <div class="panel panel-default col-lg-12" style=" border-top-left-radius: 0px; ">
			<div class="page-header">
				<h3>Messaging > Failed<span class="right"><a href="{{ url('sms/send') }}" type="button" class="btn btn-success size-12"><span class="glyphicon glyphicon-plus"></span> Send SMS</a></span></h3>
			</div>
			<br/>
			<ul class="nav nav-tabs" role="tablist">
				...
				<li role="presentation" class="active"><a href="#"><span class="glyphicon glyphicon-exclamation-sign"></span> Failed</a></li>
			</ul>
			{!! $messages->render() !!}
