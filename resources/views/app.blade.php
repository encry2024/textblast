...
<body>
	<script src="{{ URL::to('/') }}/packages/StreamTable/mustache.js" type="text/javascript"></script>
	...
	<script src="{{ URL::to('/') }}/packages/StreamTable/mustache.js" type="text/javascript"></script>
	<script src="{{ URL::to('/') }}/packages/StreamTable/stream_table.js" type="text/javascript"></script>
