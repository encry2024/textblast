...
@section('content')
	<div class="container">
		...
		{!! Form::open(array('url' => 'team/'.$team->id, 'method' => 'PUT')) !!}
		<div class="col-lg-3">
		...
		<div class="col-lg-9 col-md-offset-center-2">
			<div class="panel panel-default col-lg-12">
				<div class="page-header">
					<h3>{{ $team->name }} <a href="#" title="Edit Group's Name" data-toggle="modal" data-target="#editName"><span class="glyphicon glyphicon-pencil size-12" style="top: -1.5rem;"></span></a></h3>
				</div>
				<div class="form-group">
					<label class="col-md-4 control-label">Description</label>
					<div class="col-md-5">
						<textarea rows="5" cols="40" type="string" class="form-control" name="description">{{ $team->description }}</textarea>
					</div>
					<br/><br/><br/><br/><br/><br/>
				</div>
			</div>
			...
			<div class="panel panel-default col-lg-12">
				...
				<div class="col-lg-12">
					...
					<form class="form-inline">
						@foreach ($team->recipients as $recipientTeam)
	...
	<div class="modal fade" name="untagRecipient" id="untagRecipient" tabindex="-1" role="dialog" aria-labelledby="myModalLabels" aria-hidden="true">
		{!! Form::open(array('url'=>'team/'.$team->id.'/untag')) !!}
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12 center">
								<div class="form-group">
									<label class="col-md-12 control-label">Are you sure you want to untag <label id="rn_textbox"></label> to {{$team->name}}?</label>
								</div>
							</div>
						</div>
					</div>
...
@section('script')
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$.getJSON("{!! URL::to('/') !!}/recipients/json", function(data) {
				$.each(data, function(key, val) {
					availableTags.push({label: val, id: key});
				});
			});
